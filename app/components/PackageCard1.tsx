...
export default function ReviewPackageCard1() {
  return (
    <div className="w-full max-w-md rounded-2xl bg-linear-to-br from-blue-200 to-blue-800  shadow-xl p-6 flex flex-col gap-4">
      ...
      <div className="text-center">
        <h3 className="text-xl text-black font-semibold">
          ...
          <br />
          <span className="font-thin">(Standard)</span>
        </h3>
      ...
      {/* Price */}
      <div className="text-center">
        <p className="text-3xl font-bold text-blue-800">AED 2500</p>
      ...
      <div className="rounded-xl bg-blue-100 p-4 text-sm">
        <p className="flex justify-between">
          ...
          <span className="font-semibold">AED 1,500</span>
        </p>
      ...
      {/* Reviews List */}
      <div>
        <h4 className="font-semibold mb-2">Reviews Included (90 Total)</h4>
        <ul className="space-y-2 text-sm">
          <li className="flex items-center gap-2">
            <Check className="w-4 h-4 text-blue-500" />
            15 Reviews on Trustpilot
          </li>
          <li className="flex items-center gap-2">
            <Check className="w-4 h-4 text-blue-500" />
          ...
          <li className="flex items-center gap-2">
            <Check className="w-4 h-4 text-blue-500" />
            30 Reviews on MyLifeGB
          </li>
          <li className="flex items-center gap-2">
            <Check className="w-4 h-4 text-blue-500" />
            15 Reviews on Facebook Page
          </li>
          <li className="flex items-center gap-2">
            <Check className="w-4 h-4 text-blue-500" />
            15 Reviews on Reviews.io
          </li>
          <li className="flex items-center gap-2">
            <Check className="w-4 h-4 text-blue-500" />
            15 Reviews on Yell
